...
function ManageTransport() {
    return (
        <div>
            <h3 className="transportManageTitle">TRANSPORT SERVICES MANAGEMENT</h3>
            <ManageTransportContainer className='manageTransportPage'>
                ...
                <ManageTransportWrapper>
                    <ManageTransportCard>
                        <ManageTransportH2>ADD AMBULANCE DETAILS</ManageTransportH2>
                        <ManageTransportIcon src={addamb} />
                        <h4><NavLink to='/addTransport'>Continue</NavLink></h4>

                    </ManageTransportCard>
                    <ManageTransportCard>
                        <ManageTransportH2>VIEW AMBULANCE DETAILS</ManageTransportH2>
